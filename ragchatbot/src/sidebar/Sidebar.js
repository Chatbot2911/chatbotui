...
import bg from '../../public/logo2.jpeg'
import Image from 'next/legacy/image'

const styling = {
  backgroundImage: `url(${bg.src})`,
  backgroundSizs: 'cover',
...
const Sidebar = () => {
  ...
  const [userData,setUserData]= useState({email:"",name:'MKV'})

  useEffect(()=>{
    let userDatas = localStorage.getItem("userdata");
    userDatas = JSON.parse(userDatas)
    setUserData({email:userDatas.email||'MKV.gmail.com',name:userDatas.name||'MKV'})
  },[])
  ...
  return (
    <>
      <div className='overflow-auto rounded-lg h-auto w-2/12 relative bg-white'>
        {/* <div className="rounded-r bg-white  xl:hidden flex justify-between w-fit p-4 items-center ">
          <div className="flex justify-between  items-center space-x-3">
            ...
            <p className="text-2xl leading-6 text-black">RAG Chatbot</p>
          </div>
        ...
        <div id="Main" className="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start  w-full h-full overflow-auto flex-col p-2  " >
          <div className="hidden xl:flex justify-start items-center mb-2">
            <Image src="/logobg.jpeg" alt="Picture of the author" width={100} height={60} />
          </div>
           <div className="mt-2 flex flex-col justify-start items-center  pl-3 w-full border-gray-600 border-b space-y-2 pb-5 rounded-3xl shadow-2xl">
          ...
          <div className="flex flex-col justify-start items-center border-b border-gray-600 w-full  rounded-3xl shadow-2xl px-3">
            <button onClick={() => { showMenu1(true) }} className="focus:outline-none focus:text-sky-600 text-left  text-black flex justify-between items-center w-full py-4 space-x-14  ">
              <p className="text-sm leading-5  uppercase">Chat</p>
              <svg id="icon1" className={`transform ${icon1 ? 'rotate-180' : ''}`} width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 15L12 9L6 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
            <div id="menu1" className={`flex justify-start  flex-col w-full md:w-auto items-start pb-5 ${icon1 ? 'hidden' : ''}`}>
              <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white bg-gray-500/10 hover:bg-gray-700 text-gray-400 rounded-3xl shadow-2xl px-3 py-2  w-full ">
                <svg className="fill-stroke" xmlns="http://www.w3.org/2000/svg" fill="gray" width={24} height={24} viewBox="0 0 448 512">
                  <path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" />
                </svg>
                <p className="text-base leading-4">New Chat</p>
              </button>
            </div>
          </div>
          <div className="flex flex-col justify-start items-center  border-b border-gray-600 w-full rounded-3xl shadow-2xl px-3">
            <button onClick={() => { showMenu2(true) }} className="focus:outline-none focus:text-sky-600  text-black flex justify-between items-center w-full py-4 space-x-14  ">
              <p className="text-sm leading-5 uppercase">Prompt</p>
              <svg id="icon2" className={`transform ${icon2 ? 'rotate-180' : ''}`} width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 15L12 9L6 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
            <div className={`flex justify-start flex-col items-start pb-5 ${icon2 ? 'hidden' : ''}`}>
              <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white bg-gray-500/10 hover:bg-gray-700 text-gray-400 rounded-3xl shadow-2xl px-3 py-2  w-full">
                <svg className="fill-stroke" xmlns="http://www.w3.org/2000/svg" fill="gray" width={24} height={24} viewBox="0 0 448 512">
                  <path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" />
                </svg>
                <p className="leading-4">New Prompt</p>
              </button>
            </div>
          </div>
          <div className="flex flex-col justify-between items-center w-full border-b border-gray-600 rounded-3xl shadow-2xl px-3">
            <button onClick={() => { showMenu3(true) }} className="focus:outline-none focus:text-sky-400  text-black flex justify-between items-center w-full py-4 ">
              <p className="text-sm leading-5  uppercase">SERVICES</p>
              <svg id="icon3" className={`transform ${icon3 ? 'rotate-180' : ''}`} width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 15L12 9L6 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
            <div className={`flex justify-start flex-col items-start pb-3 ${icon3 ? 'hidden' : ''}`}>
              <button className="flex justify-start items-center space-x-4 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded-3xl px-3 py-2 m-auto">
                <svg className="fill-stroke" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded-3xl px-4 py-2 m-auto">
                <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded-3xl px-3 py-2 m-auto">
                <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 m-auto">
                <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className=" flex justify-between items-center p-2 rounded-3xl absolute bottom-3 border-2" style={{ background: "#f2fbff" }}>
              <div className="flex justify-center items-center space-x-3 mr-1">
                <div>
                  <img className="rounded-full" src="https://i.ibb.co/L1LQtBm/Ellipse-1.png" alt="avatar" />
                </div>
                <div className="flex justify-start flex-col items-start">
                  <p className="cursor-pointer text-sm leading-5 text-black">{userData.name}</p>
                  <p title={userData.email} className="cursor-pointer text-xs leading-3 text-gray-300 text-ellipsis overflow-hidden" style={{ color: "#2dc7ff",width:'100px' }}>{userData.email}</p>
                </div>
              </div>
              <svg className="cursor-pointer" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10.325 4.317C10.751 2.561 13.249 2.561 13.675 4.317C13.7389 4.5808 13.8642 4.82578 14.0407 5.032C14.2172 5.23822 14.4399 5.39985 14.6907 5.50375C14.9414 5.60764 15.2132 5.65085 15.4838 5.62987C15.7544 5.60889 16.0162 5.5243 16.248 5.383C17.791 4.443 19.558 6.209 18.618 7.753C18.4769 7.98466 18.3924 8.24634 18.3715 8.51677C18.3506 8.78721 18.3938 9.05877 18.4975 9.30938C18.6013 9.55999 18.7627 9.78258 18.9687 9.95905C19.1747 10.1355 19.4194 10.2609 19.683 10.325C21.439 10.751 21.439 13.249 19.683 13.675C19.4192 13.7389 19.1742 13.8642 18.968 14.0407C18.7618 14.2172 18.6001 14.4399 18.4963 14.6907C18.3924 14.9414 18.3491 15.2132 18.3701 15.4838C18.3911 15.7544 18.4757 16.0162 18.617 16.248C19.557 17.791 17.791 19.558 16.247 18.618C16.0153 18.4769 15.7537 18.3924 15.4832 18.3715C15.2128 18.3506 14.9412 18.3938 14.6906 18.4975C14.44 18.6013 14.2174 18.7627 14.0409 18.9687C13.8645 19.1747 13.7391 19.4194 13.675 19.683C13.249 21.439 10.751 21.439 10.325 19.683C10.2611 19.4192 10.1358 19.1742 9.95929 18.968C9.7828 18.7618 9.56011 18.6001 9.30935 18.4963C9.05859 18.3924 8.78683 18.3491 8.51621 18.3701C8.24559 18.3911 7.98375 18.4757 7.752 18.617C6.209 19.557 4.442 17.791 5.382 16.247C5.5231 16.0153 5.60755 15.7537 5.62848 15.4832C5.64942 15.2128 5.60624 14.9412 5.50247 14.6906C5.3987 14.44 5.23726 14.2174 5.03127 14.0409C4.82529 13.8645 4.58056 13.7391 4.317 13.675C2.561 13.249 2.561 10.751 4.317 10.325C4.5808 10.2611 4.82578 10.1358 5.032 9.95929C5.23822 9.7828 5.39985 9.56011 5.50375 9.30935C5.60764 9.05859 5.65085 8.78683 5.62987 8.51621C5.60889 8.24559 5.5243 7.98375 5.383 7.752C4.443 6.209 6.209 4.442 7.753 5.382C8.753 5.99 10.049 5.452 10.325 4.317Z" stroke="#2dc7ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="#2dc7ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
      </div>
